...
def get_clean_data():
    data = pd.read_csv("C:/Users/hp/Desktop/breast-cancer-prediction-ai-model/data/breast_cancer_data.csv")
...
def add_predictions(input_data):
    model = pickle.load(open('C:/Users/hp/Desktop/breast-cancer-prediction-ai-model/model/model.pkl', 'rb'))
    scaler = pickle.load(open('C:/Users/hp/Desktop/breast-cancer-prediction-ai-model/model/scaler.pkl', 'rb'))
...
def main():
    ...
    with open('C:/Users/hp/Desktop/breast-cancer-prediction-ai-model/assets/style.css') as f:
